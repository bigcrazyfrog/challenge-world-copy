...
class User(
    ...
    favorite_groups = models.ManyToManyField(
        ...
        verbose_name=_("Favorite challenge groups"),
        blank=True,
    )

    passed_events = models.ManyToManyField(
        to="events.Event",
        through="challenges.Achievement",
        related_name="attendees",
        verbose_name=_("Passed events"),
        blank=True,
        help_text=_(
            "Event for each achievement of user.",
        ),
    )
    ...
    def get_absolute_url(self) -> str:
        """Return user profile page url as absolute user url."""
