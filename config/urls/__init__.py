...
urlpatterns = [
    ...
    path("accounts/", include("apps.users.urls.auth")),
    path("users/", include("apps.users.urls")),
    path("challenges/", include("apps.challenges.urls.challenge_urls")),
    path("groups/", include("apps.challenges.urls.group_urls")),
