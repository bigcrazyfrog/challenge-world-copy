...
```bash
pyenv virtualenv-delete --force challenge-world-backend
pyenv install 3.11 --skip-existing
pyenv virtualenv `pyenv latest 3.11` challenge-world-backend
pyenv local challenge-world-backend
pyenv activate challenge-world-backend
```
